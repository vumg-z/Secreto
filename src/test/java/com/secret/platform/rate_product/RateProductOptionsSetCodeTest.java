...
@SpringJUnitConfig
public class RateProductOptionsSetCodeTest {
    ...
    @Test
    public void testCreateRateProductWithOptionSet() {
        // Mock repository behavior
        when(rateSetRepository.findByRateSetCode("DEFAULT_RATE_SET")).thenReturn(Optional.of(rateSet));
